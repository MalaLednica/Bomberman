...
import sk.uniza.fri.hra.obrazovky.MenuObrazovka;

public class MenuIkona implements IIkona {
    private final BombermanHra bombermanHra;
    private Sprite ikona;
    private SpriteBatch batch;

    public MenuIkona(BombermanHra bombermanHra, int x, int y, SpriteBatch batch) {
        this.bombermanHra = bombermanHra;
        this.ikona = new Sprite(new Texture("menu.png"));
        this.batch = batch;
        this.ikona.setX(x);
        this.ikona.setY(y);
